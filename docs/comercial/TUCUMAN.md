...
- hablar con dueños y entender cómo cotizan de verdad;
...
- fabriquen letras corpóreas, carteles luminosos, fachadas, backlight/frontlight y/o tótems;
- trabajen proyectos personalizados y no solo impresión de bajo ticket;
- tengan portfolio visible y actividad comercial;
- reciban consultas por WhatsApp, formulario, Instagram o teléfono;
- necesiten pedir varias variables antes de poder cotizar;
- puedan beneficiarse de preview visual + estimación + lead estructurado.

Evitar inicialmente:
- imprentas centradas en tarjetas/folletos;
- negocios de muy bajo ticket;
- talleres sin presencia comercial ni capacidad aparente para mantener flujo de leads;
- grandes cuentas cuyo proceso de compra sea principalmente licitaciones y no venta consultiva.

## Hipótesis comercial local

No vender inicialmente "software" ni "3D".

Gancho:
> Que tu cliente pueda ver, configurar y pedir cotización de su cartel antes de fabricarlo.

Valor:
- menos consultas vagas;
- menos ida y vuelta para pedir medidas/materiales/iluminación;
- mejor presentación comercial;
- posibilidad de precalificar presupuesto;
